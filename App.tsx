...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans max-w-md mx-auto shadow-2xl">
      ...
      <main className="flex-grow p-4 sm:p-6 bg-white pb-40">
        {!IS_API_KEY_SET && (
          <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-800 p-4 rounded-md mb-6" role="alert">
            <h3 className="font-bold">Configuration Incomplete</h3>
            <p>The Gemini API key is not set. Scanning and live result features are disabled.</p>
          </div>
        )}
      ...
      <div className="sticky bottom-0 bg-white border-t border-gray-200 flex flex-col-reverse">
        {!isAdFree && <AdBanner />}
